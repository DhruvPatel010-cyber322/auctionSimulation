...
const INIT_DATA_DIR = path.join(__dirname, '../../_dev_archive/init_data');
...
const resetAllData = async () => {
    try {
        ...
        for (const line of playerLines) {
            ...
            // BasePrice 2 -> 2 (Crores) - Explicitly parse as float to be safe
            const basePrice = isNaN(basePriceCr) ? 0.2 : basePriceCr; // Fallback if parse fails, though data seems good.
