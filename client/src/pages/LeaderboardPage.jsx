...
const LeaderboardPage = () => {
    ...
    return (
        <div className="mx-auto max-w-7xl space-y-6 p-4 md:p-8">
            <section className="overflow-hidden rounded-[36px] bg-[radial-gradient(circle_at_top_left,_rgba(255,255,255,0.2),_transparent_30%),linear-gradient(135deg,_#111827_0%,_#7f1d1d_44%,_#e11d48_100%)] px-6 py-8 text-white shadow-[0_28px_90px_rgba(15,23,42,0.24)] md:px-8">
                <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                    <div>
                        ...
                        <p className="mt-5 text-xs font-black uppercase tracking-[0.35em] text-rose-100">Fantasy Leaderboard</p>
